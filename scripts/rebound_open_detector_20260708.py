#!/usr/bin/env python3
"""Historical open-rebound detector from the 2026-07-08 manual sleeve.

The signal/state helpers are retained for offline audit and research. The script
...
def main() -> int:
    """Historical 2026-07-08 detector entrypoint; permanently live-quarantined."""
    print(
        "LEGACY_LIVE_QUARANTINED: rebound_open_detector_20260708 is retained "
